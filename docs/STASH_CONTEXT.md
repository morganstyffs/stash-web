...
**ข้อขัดแย้งที่ต้องแก้คู่กัน:** `docs/design/.../design-spec-expense-stock-app.md` §2 เขียนว่า *"flat ล้วน — ไม่มี gradient ไม่มี shadow หนัก"* ป้ายทอ (พื้นผิวผ้า + เงา) ขัดข้อนี้ตรง ๆ ต้องแก้กฎในสเปกอย่างตั้งใจ ไม่ปล่อยให้ drift
...
**เปลี่ยน token ทีเดียวทั้งแอป** ไม่ทยอย → ต้องไล่ดูหน้าสต็อก/งบ/เพิ่ม/ตั้งค่าหลัง merge
