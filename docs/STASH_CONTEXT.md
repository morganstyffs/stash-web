...
**เหตุผล + การ resolve หมวด:** ดู §11.4-28 (ถามเฉพาะขาเข้า · resolve ด้วย `kind + is_shop_category` · ห้ามชื่อไทย · ไม่ prefill ยอด)
